<?php
class ModelCatalogMVDAttribute extends Model {
	public function addAttribute($data) {
		$this->event->trigger('pre.admin.add.attribute', $data);
		
		//mvds
		$this->db->query("INSERT INTO " . DB_PREFIX . "attribute SET attribute_group_id = '" . (int)$data['attribute_group_id'] . "', vendor_id = '" . (int)$data['vendor'] . "', sort_order = '" . (int)$data['sort_order'] . "'");
		//mvde
	...
	public function editAttribute($attribute_id, $data) {
		...
		//mvds
		$this->db->query("UPDATE " . DB_PREFIX . "attribute SET attribute_group_id = '" . (int)$data['attribute_group_id'] . "', vendor_id = '" . (int)$data['vendor'] . "', sort_order = '" . (int)$data['sort_order'] . "' WHERE attribute_id = '" . (int)$attribute_id . "'");
		//mvde
