<?php
class ModelCatalogMVDInformation extends Model {
	...
	public function getInformations($data = array()) {
		if ($data) {			
			...
			//mvds
			$sql = "SELECT * FROM " . DB_PREFIX . "information i LEFT JOIN " . DB_PREFIX . "information_description id ON (i.information_id = id.information_id) LEFT JOIN " . DB_PREFIX . "vendors vds ON (i.vendor_id = vds.vendor_id) WHERE id.language_id = '" . (int)$this->config->get('config_language_id') . "'";
			//mvde
