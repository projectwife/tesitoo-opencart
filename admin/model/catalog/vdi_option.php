...
class ModelCatalogVDIOption extends Model {
	...
	public function ValidateOPDelete($option_id) {
		$query = $this->db->query("SELECT COUNT(*) AS total FROM `" . DB_PREFIX . "option` o WHERE o.option_id = '" . (int)$option_id . "' AND o.vendor_id = '0'");
		return $query->row['total'];
	}
}