        ...
        <table class="table table-bordered table-hover">
          <thead>
            <tr>
              ...
              <td class="text-left"><?php if ($sort == 'commission_name') { ?>
                ...
                <?php } ?></td>
              <td class="text-left"><?php if ($sort == 'commission_type') { ?>
          ...
          <tbody>
            ...
            <tr>
              <td class="text-center"><?php if ($commission['selected']) { ?>
                ...
                <?php } ?></td>
              <td class="text-left"><?php echo $commission['commission_name']; ?></td>
              <td class="text-left"><?php echo $commission['commission_type']; ?></td>
              <td class="text-left"><?php echo $commission['commission']; ?></td>
			  <td class="text-left"><?php echo $commission['total_vendors']; ?></td>
              <td class="text-left"><?php echo $commission['sort_order']; ?></td>
              <td class="text-left"><a href="<?php echo $commission['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
            </tr>
            <?php } ?>
            <?php } else { ?>
            <tr>
