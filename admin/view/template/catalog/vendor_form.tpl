      ...
      <div class="tab-content">
		...
		<div class="tab-pane" id="tab-setting">
		  ...
		  <div class="form-group required">
            ...
            <div class="col-sm-10">
              <input type="password" name="vendorpassword" value="<?php echo $password; ?>" placeholder="<?php echo $entry_password; ?>" id="input-password" class="form-control" autocomplete="off" />
