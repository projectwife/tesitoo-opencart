          ...
          <div class="tab-pane active" id="tab-history">
            ...
            <fieldset>
              ...
              <form class="form-horizontal">
				...
				<input type="hidden" name="override" value="1" id="input-override" />
                <div class="form-group">
...
$('#button-history').on('click', function() {
	...
	$.ajax({
		url: '<?php echo $store_url; ?>index.php?route=api/vdi_order/history&token=' + token + '&order_id=<?php echo $order_id; ?>',
		type: 'post',
		dataType: 'json',
		data: 'order_status_id=' + encodeURIComponent($('select[name=\'order_status_id\']').val()) + '&vendor_id=' + <?php echo $vendor_id;?> + '&notify=' + ($('input[name=\'notify\']').prop('checked') ? 1 : 0) + '&override=' + ($('input[name=\'override\']').prop('checked') ? 1 : 0) + '&append=' + ($('input[name=\'append\']').prop('checked') ? 1 : 0) + '&comment=' + encodeURIComponent($('textarea[name=\'comment\']').val()),
		beforeSend: function() {
