<?php
class ControllerSaleTesitooOrder extends Controller {
	private $error = array();

	public function index() {
		$this->load->language('sale/tesitoo_order');
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('sale/tesitoo_order', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);

		$data['invoice'] = $this->url->link('sale/tesitoo_order/invoice', 'token=' . $this->session->data['token'], 'SSL');
		$data['shipping'] = $this->url->link('sale/tesitoo_order/shipping', 'token=' . $this->session->data['token'], 'SSL');
		$data['add'] = $this->url->link('sale/tesitoo_order/add', 'token=' . $this->session->data['token'], 'SSL');
		...
		$order_total = $this->model_sale_tesitoo_order->getTotalOrders($filter_data);

		$results = $this->model_sale_tesitoo_order->getOrders($filter_data);
		...
		foreach ($results as $result) {
			$data['orders'][] = array(
				...
				'view'          => $this->url->link('sale/tesitoo_order/info', 'token=' . $this->session->data['token'] . '&order_id=' . $result['order_id'] . $url, 'SSL'),
				'edit'          => $this->url->link('sale/tesitoo_order/edit', 'token=' . $this->session->data['token'] . '&order_id=' . $result['order_id'] . $url, 'SSL'),
			);
		}
		...
		$data['sort_order'] = $this->url->link('sale/tesitoo_order', 'token=' . $this->session->data['token'] . '&sort=o.order_id' . $url, 'SSL');
		$data['sort_customer'] = $this->url->link('sale/tesitoo_order', 'token=' . $this->session->data['token'] . '&sort=customer' . $url, 'SSL');
		$data['sort_status'] = $this->url->link('sale/tesitoo_order', 'token=' . $this->session->data['token'] . '&sort=status' . $url, 'SSL');
		$data['sort_total'] = $this->url->link('sale/tesitoo_order', 'token=' . $this->session->data['token'] . '&sort=o.total' . $url, 'SSL');
		$data['sort_date_added'] = $this->url->link('sale/tesitoo_order', 'token=' . $this->session->data['token'] . '&sort=o.date_added' . $url, 'SSL');
		$data['sort_date_modified'] = $this->url->link('sale/tesitoo_order', 'token=' . $this->session->data['token'] . '&sort=o.date_modified' . $url, 'SSL');
		...
		$pagination->url = $this->url->link('sale/tesitoo_order', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
	...
	public function getForm() {
		...
		$data['cancel'] = $this->url->link('sale/tesitoo_order', 'token=' . $this->session->data['token'] . $url, 'SSL');

		if (isset($this->request->get['order_id'])) {
			$order_info = $this->model_sale_tesitoo_order->getOrder($this->request->get['order_id']);
		}
		...
		if (!empty($order_info)) {
			...
			$products = $this->model_sale_tesitoo_order->getOrderProducts($this->request->get['order_id']);
			...
			foreach ($products as $product) {
				$data['order_products'][] = array(
					...
					'name'       => $product['name'],
					'model'      => $product['model'],
					'option'     => $this->model_sale_tesitoo_order->getOrderOptions($this->request->get['order_id'], $product['order_product_id']),
			...
			// Vouchers
			$data['order_vouchers'] = $this->model_sale_tesitoo_order->getOrderVouchers($this->request->get['order_id']);
			...
			$order_totals = $this->model_sale_tesitoo_order->getOrderTotals($this->request->get['order_id']);
	...
	public function info() {
		...
		$order_info = $this->model_sale_tesitoo_order->getOrder($order_id);
		...
		if ($order_info) {
			...
			$data['shipping'] = $this->url->link('sale/tesitoo_order/shipping', 'token=' . $this->session->data['token'] . '&order_id=' . (int)$this->request->get['order_id'], 'SSL');
			$data['invoice'] = $this->url->link('sale/tesitoo_order/invoice', 'token=' . $this->session->data['token'] . '&order_id=' . (int)$this->request->get['order_id'], 'SSL');
			$data['edit'] = $this->url->link('sale/tesitoo_order/edit', 'token=' . $this->session->data['token'] . '&order_id=' . (int)$this->request->get['order_id'], 'SSL');
			$data['cancel'] = $this->url->link('sale/tesitoo_order', 'token=' . $this->session->data['token'] . $url, 'SSL');
			...
			foreach ($products as $product)
			{
				...
				$options = $this->model_sale_tesitoo_order->getOrderOptions($this->request->get['order_id'], $product['order_product_id']);
			...
			$vouchers = $this->model_sale_tesitoo_order->getOrderVouchers($this->request->get['order_id']);
			...
			$totals = $this->model_sale_tesitoo_order->getOrderTotals($this->request->get['order_id']);
			...
			$this->response->setOutput($this->load->view('sale/order_tesitoo_info.tpl', $data));
		} else {
	...
	public function createInvoiceNo() {
		...
		if (!$this->user->hasPermission('modify', 'sale/tesitoo_order')) {
			...
			$invoice_no = $this->model_sale_tesitoo_order->createInvoiceNo($order_id);
	...
	public function history() {
		...
		$results = $this->model_sale_tesitoo_order->getOrderHistories($this->request->get['order_id'], ($page - 1) * 10, 10);
		...
		$history_total = $this->model_sale_tesitoo_order->getTotalOrderHistories($this->request->get['order_id']);

		$pagination = new Pagination();
		$pagination->total = $history_total;
		$pagination->page = $page;
		$pagination->limit = 10;
		$pagination->url = $this->url->link('sale/tesitoo_order/history', 'token=' . $this->session->data['token'] . '&order_id=' . $this->request->get['order_id'] . '&page={page}', 'SSL');
	...
	public function invoice() {
		...
		foreach ($orders as $order_id) {
			...
			if ($order_info) {
				...
				$products = $this->model_sale_tesitoo_order->getOrderProducts($order_id);

				foreach ($products as $product) {
					$option_data = array();

					$options = $this->model_sale_tesitoo_order->getOrderOptions($order_id, $product['order_product_id']);
				...
				$vouchers = $this->model_sale_tesitoo_order->getOrderVouchers($order_id);
				...
				$totals = $this->model_sale_tesitoo_order->getOrderTotals($order_id);
