...
class ControllerCatalogVendorSetting extends Controller {
	...
	public function index() {
		...
		$data['entry_design_tab'] = $this->language->get('entry_design_tab');
		...
		$data['help_design_tab'] = $this->language->get('help_design_tab');
		...
		if (isset($this->request->post['mvd_design_tab'])) {
			$data['mvd_design_tab'] = $this->request->post['mvd_design_tab'];
		} else {
			$data['mvd_design_tab'] = $this->config->get('mvd_design_tab');
		}
