<?php
class ControllerProductProductTesitooApi extends Controller {
	private $error = array();
	...
	public function index() {
		...
		if ($product_info) {
            ...
            $data['price'] = (string)number_format(round($product_info['price'], (int)$this->currency->getDecimalPlace()), 2);
