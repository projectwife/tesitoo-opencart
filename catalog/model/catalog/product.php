      ...
      $status_sel_expr = "p.status = '1'";
		...
		if ($query->num_rows) {
			return array(
				...
				'custom_unit'      => $query->row['custom_unit']
			);
		} else {
			return false;
		}
