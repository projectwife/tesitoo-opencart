      ...
      <ul id="socialColumn" class= "socialColumnTesitoo">
        <li>
          <a href='https://play.google.com/store/apps/details?id=com.tesitoo&hl=en&pcampaignid=MKT-Other-global-all-co-prtnr-py-PartBadge-Mar2515-1' target="_blank">
            <img class="social-link" alt='Get it on Google Play' src='catalog/view/theme/atr374opc2101/image/social/google-play-badge.png'/>
          </a>
        </li>
        <li>
        ...
        <li>
          <a href="https://twitter.com/tesitooproject" target="_blank">
        ...
        <li>
          <a href="https://www.instagram.com/tesitooprojectgambia/" target="_blank">
