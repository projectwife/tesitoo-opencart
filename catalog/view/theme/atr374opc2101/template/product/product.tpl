...
<div class="container wrap_content">
  <div class="row"><?php echo $column_left; ?>
    ...
    <?php $class = 'col-sm-12'; ?>
    <?php } ?>
    <div id="content" class="<?php echo $class; ?> product-content"><?php echo $content_top; ?>
      <div class="row product-info-row">
        ...
        <?php } ?>
        <div class="<?php echo $class; ?>">
          <h1 class="product-info-title"><?php echo $heading_title; ?></h1>
              ...
              <div id="product">
                ...
                <div class="form-group buy-group">
                  ...
                  <div class="button-group add-cart-group">
                      <label>
                        <button type="button" id="button-cart" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary btn-lg btn-block"><i class="fa fa-shopping-cart"></i><span><?php echo $button_cart; ?></span></button>
                      </label>
					  <div class="btn-group">
      ...
      <div class="row product-related-row">
        <?php $i = 0; ?>
      ...
      <?php } ?>
      <?php if ($tags) { ?>
      <p class="product-info-tags"><?php echo $text_tags; ?>
